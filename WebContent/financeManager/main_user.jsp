	...
	<div class="container">
		...
		<div class="masthead">
			...
			<ul class="nav nav-justified">
				...
				<li class="active"><a
					href="/Homework/financeManager/main_user.jsp">User</a></li>
		...
		<div class="content">
			...
			<div class="pagediv">
				<ul class="pagination pagination-lg">
					...
					%>
					<li><a
						href="/Homework/financeManager/main_user.jsp?currentPage=<%=currentPage - 1%>">&laquo;</a></li>
					<%
						} else {
					%>
					<li><a href="/Homework/financeManager/main_user.jsp?currentPage=1">&laquo;</a></li>
					<%
						}
					%>
					<%
					...
					<li><a
						href="/Homework/financeManager/main_user.jsp?currentPage=<%=i%>"><%=i%></a></li>
					...
					%>
					<li><a
						href="/Homework/financeManager/main_user.jsp?currentPage=<%=currentPage + 1%>">&raquo;</a></li>
					<%
						} else {
					%>
					<li><a
						href="/Homework/financeManager/main_user.jsp?currentPage=<%=pageNum%>">&raquo;</a></li>
					<%
						}
					%>
				</ul>
