    ...
    <div class="container">
      ...
      <div class="masthead">
        ...
        <ul class="nav nav-justified">
          ...
          <li  class="active"><a href="/Homework/admin/main_user.jsp" class="active">User</a></li>
      ...
      %>     
           <table class="table table-bordered table-striped">
              ...
              <%
               for (int i = 0;i<6;i++){
            	   if(i+(currentPage-1)*6 == userList.size()) break;
              ...
              <td width="10px"><button type="button" class="btn btn-danger" onclick="window.location.href='/Homework/admin/deleteuser?deleteUserID=<%=i+(currentPage-1)*6%>&currentPage=<%=currentPage%>'">DELETE</button></td>
              <td width="10px"><button type="button" class="btn btn-info" onclick="window.location.href='/Homework/admin/modify?modifyUserID=<%=i+(currentPage-1)*6%>'">MODIFY</button></td>
              </tr>
              <%
               }
              %>
       ...
       %>
         ...
         <div class="pagediv">
             ...
             <%
                 if(currentPage > 1){
             %>
             <li><a href="/Homework/admin/main_user.jsp?currentPage=<%= currentPage-1 %>">&laquo;</a></li>
             <%
                 }else{
             %>
            ...
            %>
            <li><a href="/Homework/admin/main_user.jsp?currentPage=<%= currentPage+1 %>">&raquo;</a></li>
            <%
                }else{
            %>
            <li><a href="/Homework/admin/main_user.jsp?currentPage=<%= pageNum %>">&raquo;</a></li>
            <%
                }
            %>
         </ul>
