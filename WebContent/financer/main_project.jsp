		...
		<div class="content">
			...
			<div class="pagediv">
				<ul class="pagination pagination-lg">
					...
					%>
					<li><a
						href="/Homework/financer/main_project.jsp?currentPage=<%=currentPage - 1%>">&laquo;</a></li>
					<%
						} else {
					%>
					<li><a
						href="/Homework/financer/main_project.jsp?currentPage=1">&laquo;</a></li>
					<%
						}
					%>
					<%
					...
					<li><a
						href="/Homework/financer/main_project.jsp?currentPage=<%=i%>"><%=i%></a></li>
					...
					%>
					<li><a
						href="/Homework/financer/main_project.jsp?currentPage=<%=currentPage + 1%>">&raquo;</a></li>
					<%
						} else {
					%>
					<li><a
						href="/Homework/financer/main_project.jsp?currentPage=<%=pageNum%>">&raquo;</a></li>
					<%
						}
					%>
				</ul>
